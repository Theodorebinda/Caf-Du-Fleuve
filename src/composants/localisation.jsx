...
function Localisation({ className }) {
  return (
    <div className={`${className}`}>
      <div
        className={`flex flex-col md:flex-row md:justify-between gap-2  md:items-center`}
      >
        <div className="flex justify-start md:justify-between gap-2 items-center">
        ...
        <div className="flex justify-start md:justify-between gap-2 items-center">
          <div className="p-6 bg-[#f6f6f6]">
            <FiPhone className="font-light" size={40} />
          </div>
          <div className="flex flex-col justify-center">
